...
public enum SqlOracleType
{
    ...
    /// <summary>
    /// An Oracle NUMBER data type that contains variable-length numeric data with a maximum precision and scale of 38. This maps to Decimal. To bind an Oracle NUMBER that exceeds what MaxValue can contain, either use an OracleNumber data type, or use a String parameter and the Oracle TO_NUMBER or TO_CHAR conversion functions for input and output parameters respectively. Use the .NET Decimal or OracleClient OracleNumber data type in Value.
    /// </summary>
...
{
    public static SqlOracleType ToOracleSqlType(this DbType dbType) => dbType switch
    {
