...
public static class ExtensionsCheck
{
    ...
    private static ArgumentOutOfRangeException CheckMaxException(object argument, string argumentName, object maximumInclusive)
    {
        return new ArgumentOutOfRangeException(argumentName, $"Argument {argumentName} with value {argument} cannot be greater than the maximum value of {maximumInclusive}.");
    }

    public static byte CheckMax(this byte argument, string argumentName, byte maximumInclusive)
    {
        if (argument > maximumInclusive)
        {
            throw CheckMaxException(argument, argumentName, maximumInclusive);
        }
    ...
    private static ArgumentOutOfRangeException CheckMinException(object argument, string argumentName, object minimumInclusive)
    {
        return new ArgumentOutOfRangeException(argumentName, $"Argument {argumentName} with value {argument} cannot be less than the minimum value of {minimumInclusive}.");
    }

    public static byte CheckMin(this byte argument, string argumentName, byte minimumInclusive)
    {
        if (argument < minimumInclusive)
        {
            throw CheckMinException(argument, argumentName, minimumInclusive);
        }
    ...
    private static ArgumentOutOfRangeException CheckNotNegativeException(object argument, string argumentName)
    {
    ...
    {
        if (argument < Constant.ZERO_DECIMAL)
        {
    ...
    {
        if (argument < Constant.ZERO_DOUBLE)
        {
            throw CheckNotNegativeException(argument, argumentName);
        }
    ...
    {
        if (argument < Constant.ZERO_FLOAT)
        {
            throw CheckNotNegativeException(argument, argumentName);
        }
    ...
    {
        if (argument < Constant.ZERO_LONG)
        {
            throw CheckNotNegativeException(argument, argumentName);
        }
    ...
    {
        if (argument < Constant.ZERO_SHORT)
        {
            throw CheckNotNegativeException(argument, argumentName);
        }
    ...
    private static ArgumentOutOfRangeException CheckNotZeroException(object argument, string argumentName)
    {
        return new ArgumentOutOfRangeException(argumentName, $"Argument {argumentName} with value {argument} cannot be zero.");
    }
    ...
    public static byte CheckNotZero(this byte argument, string argumentName)
    {
        ...
        {
            throw CheckNotZeroException(argument, argumentName);
        }
    ...
    {
        if (argument == Constant.ZERO_SBYTE)
        {
            throw CheckNotZeroException(argument, argumentName);
        }
    ...
    {
        if (Math.Abs(argument) < Math.Abs(tolerance))
        {
            throw CheckNotZeroException(argument, argumentName);
        }
    ...
    {
        if (argument == Constant.ZERO_UINT)
        {
            throw CheckNotZeroException(argument, argumentName);
        }
    ...
    {
        if (argument == Constant.ZERO_ULONG)
        {
            throw CheckNotZeroException(argument, argumentName);
        }
    ...
    {
        if (argument == Constant.ZERO_USHORT)
        {
            throw CheckNotZeroException(argument, argumentName);
        }
    ...
    private static ArgumentOutOfRangeException CheckNotZeroNotNegativeException(object argument, string argumentName)
    {
        return new ArgumentOutOfRangeException(argumentName, $"Argument {argumentName} with value {argument} cannot be negative or zero.");
    }
    ...
    public static byte CheckNotZeroNotNegative(this byte argument, string argumentName)
    {
        if (argument <= Constant.ZERO_BYTE)
        {
            throw CheckNotZeroNotNegativeException(argument, argumentName);
        }
    ...
    public static T[] CheckNotContains<T>(this T[] argument, T argumentToCheckFor, string argumentName)
    {
        return CheckNotContains(argument, argumentToCheckFor, null, argumentName);
    }
    ...
    public static T[] CheckOnlyContains<T>(this T[] argument, T[] validArguments, string argumentName)
    {
        return CheckOnlyContains(argument, validArguments, null, argumentName);
    }
