...
namespace HavokMultimedia.Utilities.Console.Commands
{
    ...
    public class GenerateKeyPair : Command
    {
        ...
        protected override void Execute()
        {
            ...
            {
                Util.FileWrite(publicKeyFile, ExportPublicKey(rsa), Constant.ENCODING_UTF8_WITHOUT_BOM);
                Util.FileWrite(privateKeyFile, ExportPrivateKey(rsa), Constant.ENCODING_UTF8_WITHOUT_BOM);
            }
