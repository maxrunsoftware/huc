        ...
        protected override void ExecuteInternal(ActiveDirectory ad)
        {
            ...
            if (lastLoginDays != null)
            {
                ...
                foreach (var user in users)
                {
                    ...
                    if (user.LastLogon != null) if (user.LastLogon.Value > lastLogon) lastLogon = user.LastLogon.Value;
                    if (user.LastLogonTimestamp != null) if (user.LastLogonTimestamp.Value > lastLogon) lastLogon = user.LastLogonTimestamp.Value;
