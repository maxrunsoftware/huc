...
{
    public class ActiveDirectoryDisableUser : ActiveDirectoryBase
    {
        protected override void CreateHelp(CommandHelpBuilder help)
        {
            base.CreateHelp(help);
            help.AddSummary("Disables a user in ActiveDirectory");
        ...
        protected override void ExecuteInternal(ActiveDirectory ad)
        {
            ...
            log.Debug("Disabling user " + samAccountName);
            ad.DisableUser(samAccountName);
            log.Info("Successfully disabled user " + samAccountName);
        }
    }
}
