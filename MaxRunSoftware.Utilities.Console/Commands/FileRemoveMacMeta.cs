...
namespace MaxRunSoftware.Utilities.Console.Commands
{
    public class FileRemoveMacMeta : Command
    {
        protected override void CreateHelp(CommandHelpBuilder help)
        {
            ...
            help.AddDetail("WARNING: Running on an Apple/Mac system may cause unpredictable results and is not recommmended");
        ...
        protected override void ExecuteInternal()
        {
            ...
            var filesToDelete = Util.FileListFiles(targetDirectory, recursive: recursive).Where(IsMacTrash).ToList();
