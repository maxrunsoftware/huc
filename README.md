...
- [File Operations](#file-replacement)
    - [String Replacement](#file-replacement)
    - [Appending](#file-appending)
    - [Split](#file-split)
    - [Checksums](#file-checksum)
    - [Encryption and Decryption](#file-encryption-and-decryption)
- [Directory Operations](#directory-list)
    - [List](#directory-list)
    - [Size](#directory-size)
    - [Flatten](#directory-flatten)
    - [Remove Empty](#directory-remove-empty)
