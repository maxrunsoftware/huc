...
public class ActiveDirectoryObject : IEquatable<ActiveDirectoryObject>, IComparable<ActiveDirectoryObject>
{
    ...
    private static readonly DateTime JAN_01_1800 = new(1800, 1, 1);
    ...
    private Lazy<DirectoryEntry> directoryEntry;
    private DirectoryEntry DirectoryEntry => directoryEntry.Value;

    private Lazy<UserPrincipal> userPrincipal;
    private UserPrincipal UserPrincipal => userPrincipal.Value;
    ...
    {
        get => Attributes.GetString("comment");
        set => AttributeSave("comment", value.TrimOrNull());
    }

    public string Company
    {
        get => Attributes.GetString("company");
        set => AttributeSave("company", value.TrimOrNull());
    }

    public string CountryCode
    {
        get => Attributes.GetString("countryCode");
        set => AttributeSave("countryCode", value.TrimOrNull());
    }
    ...
    {
        get => Attributes.GetString("department");
        set => AttributeSave("department", value.TrimOrNull());
    }

    public string Description
    {
        get => Attributes.GetString("description");
        set => AttributeSave("description", value.TrimOrNull());
    }

    public string DisplayName
    {
        get => Attributes.GetString("displayName");
        set => AttributeSave("displayName", value.TrimOrNull());
    }

    public string DisplayNamePrintable
    {
        get => Attributes.GetString("displayNamePrintable");
        set => AttributeSave("displayNamePrintable", value.TrimOrNull());
    }
    ...
    {
        get => Attributes.GetString("employeeNumber");
        set => AttributeSave("employeeNumber", value.TrimOrNull());
    }

    public string GivenName
    {
        get => Attributes.GetString("givenName");
        set => AttributeSave("givenName", value.TrimOrNull());
    }

    public string UID
    {
        get => Attributes.GetString("uid");
        set => AttributeSave("uid", value.TrimOrNull());
    }
    ...
    {
        get => Attributes.GetString("homeDirectory");
        set => AttributeSave("homeDirectory", value.TrimOrNull());
    }

    public string HomeDrive
    {
        get => Attributes.GetString("homeDrive");
        set => AttributeSave("homeDrive", value.TrimOrNull());
    }
    ...
    public string Info
    {
        get => Attributes.GetString("info");
        set => AttributeSave("info", value.TrimOrNull());
    }

    public string Initials
    {
        get => Attributes.GetString("initials");
        set => AttributeSave("initials", value.TrimOrNull());
    }
    ...
    {
        get => Attributes.GetString("location");
        set => AttributeSave("location", value.TrimOrNull());
    }

    public string LockoutTime
    {
        get => Attributes.GetString("lockoutTime");
        set => AttributeSave("lockoutTime", value.TrimOrNull());
    }
    ...
    public string Mail
    {
        get => Attributes.GetString("mail");
        set => AttributeSave("mail", value.TrimOrNull());
    }

    public string MailNickname
    {
        get => Attributes.GetString("mailNickname");
        set => AttributeSave("mailNickname", value.TrimOrNull());
    }

    public string ManagedBy
    {
        get => Attributes.GetString("managedBy");
        set => AttributeSave("managedBy", value.TrimOrNull());
    }
    ...
    public string Name
    {
        get => Attributes.GetString("name");
        set => AttributeSave("name", value.TrimOrNull());
    }
    ...
    {
        get => Attributes.GetString("physicalDeliveryOfficeName");
        set => AttributeSave("physicalDeliveryOfficeName", value.TrimOrNull());
    }
    ...
    {
        get => Attributes.GetString("profilePath");
        set => AttributeSave("profilePath", value.TrimOrNull());
    }
    ...
    {
        get => Attributes.GetString("sAMAccountName");
        set => AttributeSave("sAMAccountName", value.TrimOrNull());
    }
    ...
    {
        get => Attributes.GetString("sAMAccouscriptPathntName");
        set => AttributeSave("scriptPath", value.TrimOrNull());
    }
    ...
    public string Sn
    {
        get => Attributes.GetString("sn");
        set => AttributeSave("sn", value.TrimOrNull());
    }
    ...
    {
        get => Attributes.GetString("targetAddress");
        set => AttributeSave("targetAddress", value.TrimOrNull());
    }

    public string TelephoneNumber
    {
        get => Attributes.GetString("telephoneNumber");
        set => AttributeSave("telephoneNumber", value.TrimOrNull());
    }

    public string UNCName
    {
        get => Attributes.GetString("uNCName");
        set => AttributeSave("uNCName", value.TrimOrNull());
    }

    public string Url
    {
        get => Attributes.GetString("url");
        set => AttributeSave("url", value.TrimOrNull());
    }
    ...
    {
        get => Attributes.GetString("userPrincipalName");
        set => AttributeSave("userPrincipalName", value.TrimOrNull());
    }
    ...
    {
        get => Attributes.GetString("wWWHomePage");
        set => AttributeSave("wWWHomePage", value.TrimOrNull());
    }
    ...
    public string LogonNamePreWindows2000
    {
        get => SAMAccountName;
    ...
    private ActiveDirectoryObject(ActiveDirectoryCore activeDirectory, LdapEntryAttributeCollection attributes)
    {
        ...
        directoryEntry = new Lazy<DirectoryEntry>(() => activeDirectory.Ldap.GetDirectoryEntryByDistinguishedName(DistinguishedName));
        userPrincipal = new Lazy<UserPrincipal>(() => activeDirectory.Ldap.GetUserPrincipalByDistinguishedName(DistinguishedName));
    }
    ...
    public override int GetHashCode() => Util.Hash(DistinguishedName?.ToUpper(), ObjectGUID);
