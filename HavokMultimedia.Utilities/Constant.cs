...
namespace HavokMultimedia.Utilities
{
    public static class Constant
    {
        ...
        public static readonly Encoding ENCODING_UTF8_WITHOUT_BOM = new UTF8Encoding(false);
        public static readonly Encoding ENCODING_UTF8_WITH_BOM = new UTF8Encoding(true);
